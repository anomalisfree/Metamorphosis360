...
namespace Mapbox.Unity.MeshGeneration.Data
{
	...
	public class UnityTile : MonoBehaviour
	{
		...
		public void SetRasterData(byte[] data, bool useMipMap = true, bool useCompression = false)
		{
			...
			if (_rasterData == null)
			{
				// Create with minimal valid size, LoadImage will resize it properly
			...
			{
			UnityEngine.Debug.LogError($"Failed to load raster data for tile {CanonicalTileId}: {ex.Message}");
				UnityEngine.Debug.LogError($"Failed to load raster data for tile {CanonicalTileId}: {ex.Message}");
