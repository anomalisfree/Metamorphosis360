Shader "Mapbox/MapboxStylesPerRenderer" 
{
    ...
    SubShader 
    {
        ...
        Pass
        {
            ...
            // PerRendererData properties
            UNITY_INSTANCING_BUFFER_START(Props)
                UNITY_DEFINE_INSTANCED_PROP(float4, _BaseColor)
                UNITY_DEFINE_INSTANCED_PROP(float4, _DetailColor1)
                UNITY_DEFINE_INSTANCED_PROP(float4, _DetailColor2)
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                float4 detailColor1 = UNITY_ACCESS_INSTANCED_PROP(Props, _DetailColor1);
                float4 detailColor2 = UNITY_ACCESS_INSTANCED_PROP(Props, _DetailColor2);
                ...
                half4 baseDetail1_Result = lerp(baseColor, detailColor1, detailTexture1.a);
                half4 detail1Detail2_Result = lerp(baseDetail1_Result, detailColor2, detailTexture2.a);
